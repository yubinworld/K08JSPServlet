...
/* 
	...
	가 된다. 여기에 HTML태그들이 있으므로 해당 페이지의 용량은
	1kb를 초과하게 되어 실행시 에러가 발생한다
	해결방법은 buffer 의 용량을 늘리거나, autoFlush를 true로 변경하면
	된다.
...
/* 
	...
	이를통해 에러페이지처리나 포워드 등의 기능을 수행할 수 있게된다.
	
	위와같은 이유로 jSPㅔㅇ서 buffer의 용량을 지정하는 경우는 거의없다.
	단, jsp가 웹브라우저에 내용를 출력할때 버퍼를 사용하는 것을 인지하고
	이를 통해 에러페이지 처리나 포워드 등의 기능을 수행할 수 있게된다.ds
*/
%>
</body>
</html>
