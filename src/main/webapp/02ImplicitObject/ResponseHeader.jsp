...
응답헤더에 날짜를 지정하는 경우 대한민국은 세계표준시 +09 즉 
9시간이느리므로 9시간을 더해줘야 정상적인 날짜가 출력된다. 
...
<body>
    ...
    이때동일한 값 8282가 출력된다. 이것은 getHeader()
    메소드의 특성으로 처음 입력한 헤더값만 출력되게한다.
    */
    %>
    ...
    <%
    /* 
   	myNumber 라는 헤더명으로 2개의 값을 추가했으므로 아래에서는 각각의
